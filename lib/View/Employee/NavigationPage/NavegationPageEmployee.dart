...
class NavegationPageEmployee extends StatelessWidget {
  const NavegationPageEmployee({super.key});

  @override
  Widget build(BuildContext context) {
    return Consumer<NavegationPageEmployeeController>(
      builder: (context, controller, child) => Scaffold(
        ...
        body: controller.employeeScreen[controller.selectedIndex],
